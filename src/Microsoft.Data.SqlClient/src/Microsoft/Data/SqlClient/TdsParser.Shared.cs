...
namespace Microsoft.Data.SqlClient
{
    ...
    internal partial class TdsParser
    {
        internal void ProcessSSPI(int receivedLength)
        {
            ...
            using var sendBuff = _authenticationProvider!.SSPIData(receivedBuff.AsMemory(0, receivedLength));
            ...
            SqlConnectionEncryptOption encrypt)
        {
            ...
            else
            {
                if (rec.useSSPI)
                {
                    ...
                    outSSPIBuff = _authenticationProvider.SSPIData(Array.Empty<byte>());
            ...
            var outSSPISpan = ReadOnlySpan<byte>.Empty;

            if (outSSPIBuff is not null)
            {
                outSSPISpan = outSSPIBuff.Memory.Span;
            }
